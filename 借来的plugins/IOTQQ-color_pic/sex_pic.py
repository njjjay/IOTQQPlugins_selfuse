...
def setuapi_0(tag='', num=1, r18=True):
...
def setuapi_1(keyword='', num=1, r18=True):
    print('尝试从lolicon获取')
...
def send_setu(a, keyword, num=1, r18=True):
...
def send_setu_friend(a, keyword, num=1, r18=True):
    print('尝试获取{0}张色图'.format(num))
